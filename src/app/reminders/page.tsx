    ...
    <main className="min-h-screen bg-[#f8faf7] px-4 py-5 text-slate-900 sm:px-6">
      <section className="mx-auto flex w-full max-w-5xl flex-col gap-5">
        <header className="rounded-lg border border-emerald-100 bg-white p-5 shadow-sm">
          ...
          <h1 className="mt-2 text-2xl font-semibold text-slate-950">Farm reminders</h1>
          <p className="mt-2 text-sm leading-6 text-slate-600">
            See overdue and upcoming vaccination, pregnancy, and health follow-up reminders in one place.
          </p>
        </header>
